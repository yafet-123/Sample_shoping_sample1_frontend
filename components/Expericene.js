...
export function Expericene() {
  return (
    <div className="bg-white w-full h-full p-20 flex flex-col">
      <h1 className="text-5xl text-black max-w-4xl mx-auto mb-5 text-center font-light">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-10 px-20 w-full h-full">
        <div className="bg-blue-500 w-full h-[35rem] rounded-2xl px-10 mt-28">
        ...
        <div className="bg-blue-700 w-full h-[35rem] rounded-2xl px-10 mt-28">
        ...
        <div className="bg-red-700 w-full h-[35rem] rounded-2xl px-10 mt-28">
